...
#check if the country name column is availible in all datasets
datasets <- list(renew_energy_1, access_to_electrcity_1, private_investment_1, gini_index_1,
...
#getting proper country names (the 'country names' here actually contain larger groups like "Arab World" etc when I only want to look at things at a country level)
...
list_names <- c("renew_energy_1", "access_to_electrcity_1", "private_investment_1", "gini_index_1",
                "gdp_current_1", "gdp_growth_1", "gdp_per_capita_1", "gdp_per_capita_growth_1")
...
write.csv(new_dataframe, "cleaned_df_for_renewable_energy_regression.csv")
